...
public class CompanyController {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<CompanyDto>> getAllCompany(@RequestBody Pageable pageable) {
        return ResponseEntity.ok(companyService.getAllCompanies(pageable).getList());
    }
